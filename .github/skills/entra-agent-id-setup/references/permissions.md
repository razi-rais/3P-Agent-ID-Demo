...
| Agent ID Developer | `adb2368d-a9be-41b5-8667-d96778e081b0` | Agent ID-specific | **Least-privileged that works — empirically verified 2026-04-21** on tenant `e325cd37-67d5-421b-9ca3-40108b21d74a`. Per Learn: *"Create an agent blueprint and its service principal in a tenant. User will be added as an owner."* |
...
Empirical verification on tenant `e325cd37-67d5-421b-9ca3-40108b21d74a`:
- **2026-04-20**: App Admin + Cloud App Admin → 403 on blueprint create; Global Admin → success
- **2026-04-21**: Tester stripped to **only** `Agent ID Developer` → `Start-EntraAgentIDWorkflow` succeeded end-to-end (Blueprint `77f40bb9-b3de-4891-86eb-2efd00d7aedb` + Agent `cf054f90-5a82-4d02-9eae-03859422b3cf` created, `User.Read.All` granted, T1/T2 tokens issued). Confirms Agent ID Developer is the real floor.
